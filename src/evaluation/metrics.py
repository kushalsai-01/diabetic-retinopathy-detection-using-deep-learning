...
def compute_metrics(
    ...
    if y_proba is not None:
        try:
            metrics["auc_per_class"] = roc_auc_score(y_true, y_proba, multi_class="ovr", average=None)
...
def binary_metrics_referable_dr(y_true: np.ndarray, y_pred: np.ndarray) -> Dict[str, float]:
